...
def run_clustering():
    ...
    for col in features.values():
        ...
        df_imputed[col] = df_imputed.groupby('broad_sector')[col].transform(lambda x: x.fillna(x.median()))
    ...
    logger.info(f"Clustering complete. Generated {output_path} and {REPORTS_DIR}/elbow_plot.png")
